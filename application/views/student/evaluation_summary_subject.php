                    ...
                    <div class="panel-body">
                        ...
                        <br>
                         <?php
                            ...
                            //First Group
                            $aname1 = $this->facultymod->get_points_qce_subject('group1', 'aname1', $id, $subject);
                            $aname2 = $this->facultymod->get_points_qce_subject('group1', 'aname2', $id, $subject);
                            $aname3 = $this->facultymod->get_points_qce_subject('group1', 'aname3', $id, $subject);
                            $aname4 = $this->facultymod->get_points_qce_subject('group1', 'aname4', $id, $subject);
                            $aname5 = $this->facultymod->get_points_qce_subject('group1', 'aname5', $id, $subject);
                            $anamelowest = $this->facultymod->get_lowest_subject('group1', $id, $subject);
                            $anametotal = $aname1 + $aname2 + $aname3 + $aname4 + $aname5;

                            //Second Group
                            $bname1 = $this->facultymod->get_points_qce_subject('group2', 'bname1', $id, $subject);
                            $bname2 = $this->facultymod->get_points_qce_subject('group2', 'bname2', $id, $subject);
                            $bname3 = $this->facultymod->get_points_qce_subject('group2', 'bname3', $id, $subject);
                            $bname4 = $this->facultymod->get_points_qce_subject('group2', 'bname4', $id, $subject);
                            $bname5 = $this->facultymod->get_points_qce_subject('group2', 'bname5', $id, $subject);
                            $bnamelowest = $this->facultymod->get_lowest_subject('group2', $id, $subject);
                            $bnametotal = $bname1 + $bname2 + $bname3 + $bname4 + $bname5;
                            //Third Group
                            $cname1 = $this->facultymod->get_points_qce_subject('group3', 'cname1', $id, $subject);
                            $cname2 = $this->facultymod->get_points_qce_subject('group3', 'cname2', $id, $subject);
                            $cname3 = $this->facultymod->get_points_qce_subject('group3', 'cname3', $id, $subject);
                            $cname4 = $this->facultymod->get_points_qce_subject('group3', 'cname4', $id, $subject);
                            $cname5 = $this->facultymod->get_points_qce_subject('group3', 'cname5', $id, $subject);
                            $cnamelowest = $this->facultymod->get_lowest_subject('group3', $id, $subject);
                            $cnametotal = $cname1 + $cname2 + $cname3 + $cname4 + $cname5;
                            //Fourth Group
                            $dnamelowest = $this->facultymod->get_lowest_subject('group4', $id, $subject);
                            $dname1 = $this->facultymod->get_points_qce_subject('group4', 'dname1', $id, $subject);
                            $dname2 = $this->facultymod->get_points_qce_subject('group4', 'dname2', $id, $subject);
                            $dname3 = $this->facultymod->get_points_qce_subject('group4', 'dname3', $id, $subject);
                            $dname4 = $this->facultymod->get_points_qce_subject('group4', 'dname4', $id, $subject);
                            $dname5 = $this->facultymod->get_points_qce_subject('group4', 'dname5', $id, $subject);
                        ...
                        <?php
                             ...
                             $xtra = explode(' - ', $ds);
                             $subdescription = $this->facultymod->get_subject_description($subject);
                        ?>
                        <h4 class="text-center">Note. The highlited Part is lowest Points in your Evaluation</h4>
                        <center><b>Subject:&nbsp;&nbsp;<?php echo $subdescription ?></b></center>
